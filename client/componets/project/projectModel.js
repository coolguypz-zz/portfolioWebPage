class ProjectModel {
  ...
  renderProject() {
    ...
    aTag.append(imageDiv, this.renderInnerLayer());
  ...
  renderInnerLayer() {
    ...
    <g>
      <path clip-rule="evenodd"
        d="M296.133,354.174c49.885-5.891,102.942-24.029,102.942-110.192   
    ...
    `)
    gitHubDiv.append(gitHubSvg)
    gitHub.append(gitHubDiv)
    innerLayer.append( aWebsite, skill, gitHub);
    return innerLayer;
  }
}
